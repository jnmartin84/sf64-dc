# Star Fox 64 for Sega Dreamcast (updated 2026/08/23)

Now with hardware-mixed audio, raw PowerVR Fast 3D backend with significant N64-accuracy enhancements and all around improved performance.

You can upload a ROM and download a CDI.

Find more details here: https://colab.research.google.com/drive/1Suq7tQBAULNhyqxRV6TTFjnrDPYgndGm
...
![Title Screen](/media/screenshot1.png)
![Titania](/media/screenshot2.png)
![Zoness](/media/screenshot3.png)
![Corneria](/media/screenshot4.png)
