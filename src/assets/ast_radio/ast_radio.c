...
u8 gTextCharTextures[][104] = {
	{
		#include "src/assets/ast_radio/text_char_special_0.ci4.inc.c"
	},
	{
		#include "src/assets/ast_radio/text_char_special_4.ci4.inc.c"
	},
	{
		#include "src/assets/ast_radio/text_char_special_8.ci4.inc.c"
	},
	{
		#include "src/assets/ast_radio/text_char_special_12.ci4.inc.c"
	},
	{
		#include "src/assets/ast_radio/text_char_cdir.ci4.inc.c"
	},
	{
		#include "src/assets/ast_radio/text_char_adir.ci4.inc.c"
	},
	{
		#include "src/assets/ast_radio/text_char_abcd_upper.ci4.inc.c"
	},
	{
		#include "src/assets/ast_radio/text_char_efgh_upper.ci4.inc.c"
	},
	{
		#include "src/assets/ast_radio/text_char_ijkl_upper.ci4.inc.c"
	},
	{
		#include "src/assets/ast_radio/text_char_mnop_upper.ci4.inc.c"
	},
	{
		#include "src/assets/ast_radio/text_char_qrst_upper.ci4.inc.c"
	},
	{
		#include "src/assets/ast_radio/text_char_uvwx_upper.ci4.inc.c"
	},
	{
		#include "src/assets/ast_radio/text_char_yzab_both.ci4.inc.c"
	},
	{
		#include "src/assets/ast_radio/text_char_cdef_lower.ci4.inc.c"
	},
	{
		#include "src/assets/ast_radio/text_char_ghij_lower.ci4.inc.c"
	},
	{
		#include "src/assets/ast_radio/text_char_klmn_lower.ci4.inc.c"
	},
	{
		#include "src/assets/ast_radio/text_char_opqr_lower.ci4.inc.c"
	},
	{
		#include "src/assets/ast_radio/text_char_stuv_lower.ci4.inc.c"
	},
	{
		#include "src/assets/ast_radio/text_char_wxyz_lower.ci4.inc.c"
	},
	{
		#include "src/assets/ast_radio/text_char_pidc.ci4.inc.c"
	},
	{
		#include "src/assets/ast_radio/text_char_p012.ci4.inc.c"
	},
	{
		#include "src/assets/ast_radio/text_char_3456.ci4.inc.c"
	},
	{
		#include "src/assets/ast_radio/text_char_789a.ci4.inc.c"
	},
	{
		#include "src/assets/ast_radio/text_char_ppdp.ci4.inc.c"
	},
};
...
//    LPR, _Z, SPC, _o, _r, SPC, _R, SPC, _t, _w, _i, _c, _e, RPR, EXM, NWL, 
    LPR, _L, SPC, _o, _r, SPC, _R, SPC, _t, _w, _i, _c, _e, RPR, EXM, NWL, 
    END, 
};
// You've got an enemy 
// on your tail!
...
u16 gMsg_ID_2118[] = {
    ...
    LPR, _p, _r, _e, _s, _s, SPC, _t, _h, _e, NWL, _B, SPC, //_C, ADN, SPC, CDN, NWL, 
...
u16 gMsg_ID_4030[] = {
    ...
    LPR, _L, SPC, _a, _n, _d, SPC, _R, RPR, PRD, NWL, 
    END, 
};
// Enemy fighters
// comin' at you, Fox.
...
u16 gMsg_ID_20235[] = {
    ...
    _c, _h, _a, _s, _e, SPC, LPR, _Y, RPR, PRD, NWL, //_C, ALF, SPC, CLF, RPR, PRD, NWL, 
    END, 
};
// Try a somersault
// (v and C< (C<)).
...
//    LPR, ADN, SPC, _a, _n, _d, SPC, _C, ADN, SPC, CDN, RPR, PRD, NWL, 
    LPR, ADN, SPC, _a, _n, _d, SPC, _B, RPR, PRD, NWL, // ADN, SPC, CDN, RPR, PRD, NWL, 
    END, 
};
// Use bombs wisely
// (B Button).
...
//    LPR, _B, SPC, _B, _u, _t, _t, _o, _n, RPR, PRD, NWL, 
    LPR, _X, SPC, _B, _u, _t, _t, _o, _n, RPR, PRD, NWL, 
    END, 
};
// Use the boost to
// get thru (C< (C<)).
...
// boost!
u16 gMsg_ID_20286[] = {
    PRI2, _P, _r, _e, _s, _s, SPC, _Y, SPC, _t, _o, NWL,// _C, ALF, SPC, CLF, SPC, _t, _o, NWL, 
...
// to do a somersault.
u16 gMsg_ID_20287[] = {
    PRI2, _P, _r, _e, _s, _s, SPC, ADN, SPC, _a, _n, _d, SPC, _Y, SPC, NWL, //_C, ALF, SPC, CLF, SPC, NWL, 
...
u16 gMsg_ID_20288[] = {
    ...
    _p, _r, _e, _s, _s, SPC, ADN, SPC, _a, _n, _d, SPC, _B, PRD, /* _C, ADN, SPC, CDN, PRD, */ NWL, 
    END, 
};
// Press B to bomb.
u16 gMsg_ID_20289[] = {
//    PRI2, _P, _r, _e, _s, _s, SPC, _B, SPC, _t, _o, SPC, _b, _o, _m, _b, PRD, NWL, 
    PRI2, _P, _r, _e, _s, _s, SPC, _X, SPC, _t, _o, SPC, _b, _o, _m, _b, PRD, NWL, 
    END, 
};
// To barrel roll, 
// press Z or R twice.
...
//    _p, _r, _e, _s, _s, SPC, _Z, SPC, _o, _r, SPC, _R, SPC, _t, _w, _i, _c, _e, PRD, NWL, 
    _p, _r, _e, _s, _s, SPC, _L, SPC, _o, _r, SPC, _R, SPC, _t, _w, _i, _c, _e, PRD, NWL, 
    END, 
};
// Press Cv (Cv)
// to brake.
u16 gMsg_ID_20291[] = {
    PRI2, _P, _r, _e, _s, _s, SPC, _B, SPC, _B, _u, _t, _t, _o, _n, NWL,//_C, ADN, SPC, CDN, NWL, 
...
u16 gMsg_ID_20292[] = {
    ...
    _p, _r, _e, _s, _s, SPC, _L, SPC, _a, _n, _d, SPC, _R, PRD, NWL, 
    END, 
};
// Slippy!!!
u16 gMsg_ID_20294[] = {
...
//    PRI1, _P, _r, _e, _s, _s, SPC, _Z, SPC, _o, _r, SPC, _R, SPC, _t, _o, NWL, 
    PRI1, _P, _r, _e, _s, _s, SPC, _L, SPC, _o, _r, SPC, _R, SPC, _t, _o, NWL, 
...
//    PRI1, _P, _r, _e, _s, _s, SPC, _Z, SPC, _o, _r, SPC, _R, SPC, _t, _w, _i, _c, _e, NWL, 
    PRI1, _P, _r, _e, _s, _s, SPC, _L, SPC, _o, _r, SPC, _R, SPC, _t, _w, _i, _c, _e, NWL, 
...
//    PRI1, _P, _r, _e, _s, _s, SPC, _B, SPC, _t, _o, SPC, _b, _o, _m, _b, PRD, NWL, 
    PRI1, _P, _r, _e, _s, _s, SPC, _X, SPC, _t, _o, SPC, _b, _o, _m, _b, PRD, NWL, 
...
// boost.
u16 gMsg_ID_23015[] = {
    PRI1, _P, _r, _e, _s, _s, SPC, _Y, SPC, _f, _o, _r, NWL, //_C, ALF, SPC, CLF, SPC, _f, _o, _r, NWL, 
...
// brake.
u16 gMsg_ID_23016[] = {
    PRI1, _P, _r, _e, _s, _s, SPC, _B, SPC, _t, _o, NWL, //_C, ADN, SPC, CDN, SPC, _t, _o, SPC, NWL, 
...
u16 gMsg_ID_23017[] = {
    ...
    _p, _r, _e, _s, _s, SPC, ADN, SPC, _a, _n, _d, SPC, _Y, PRD, NWL,//_C, ALF, SPC, CLF, PRD, NWL, 
    END, 
};
// You can U-turn in
// all-range mode.
...
// to U-turn.
u16 gMsg_ID_23019[] = {
    PRI1, _P, _r, _e, _s, _s, SPC, ADN, SPC, _a, _n, _d, SPC, _B, NWL, //_C, ADN, SPC, CDN, NWL, 
