...
Credit D_ending_80192E74[] = {
    ...
    (u8*)"ART DIRECTOR",		        630,	180,    0,  60,    0,	0, 25, 20,
    (u8*)"TAKAYA IMAMURA",		    630,	180,    0,  80,    1,	0, 25, 20,
    
    (u8*)"CHIEF PROGRAMMER",		    830,	180,    0,  60,    0,	0, 25, 20,
    (u8*)"KAZUAKI MORITA",		    830,	180,    0,  80,    1,	0, 25, 20,
    
    (u8*)"SOUND COMPOSERS",		    1030,	180,    0,  60,    0,	0, 25, 20,
    (u8*)"KOJI KONDO",		        1030,	180,    0,  80,    1,	0, 25, 20,
    (u8*)"HAJIME WAKAI",		        1030,	180,    0,  110,   1,	0, 25, 20,
    
    (u8*)"SOUND EFFECTS PROGRAMMER",	1250,	180,    0,  60,    0,	0, 25, 20,
    (u8*)"YOJI INAGAKI",		        1250,	180,    0,  80,    1,	0, 25, 20,
    
    (u8*)"GRAPHIC DESIGNERS",	    1490,	180,    0,  60,    0,	0, 25, 20,
    (u8*)"YOSHIKI HARUHANA",		    1490,	180,    0,  80,    1,	0, 25, 20,
    (u8*)"SATORU TAKIZAWA",		    1490,	180,    0,  110,   1,	0, 25, 20,
    (u8*)"MASANORI SATO",		    1490,	180,    0,  140,   1,	0, 25, 20,
    
    (u8*)"COURSE DESIGNERS",		    2000,	180,    0,  60,    0,	0, 25, 20,
    (u8*)"YASUHISA YAMAMURA",	    2000,	180,    0,  80,    1,	0, 25, 20,
    (u8*)"TAKUJI HOTTA",		        2000,	180,    0,  110,   1,	0, 25, 20,
    (u8*)"COURSE DESIGNERS",		    2370,	180,    0,  60,    0,	0, 25, 20,
    (u8*)"DAISUKE TSUJIMURA",	    2370,	180,    0,  80,    1,	0, 25, 20,
    (u8*)"YASUYUKI OYAGI",		    2370,	180,    0,  110,   1,	0, 25, 20,
    
    (u8*)"PROGRAMMERS",		        2820,	180,    0,  60,    0,	0, 25, 20,
    (u8*)"YUICHI YAMAMOTO",		    2820,	180,    0,  80,    1,	0, 25, 20,
    (u8*)"NOBUO OKAJIMA",		    2820,	180,    0,  110,   1,	0, 25, 20,
    
    (u8*)"PROGRAMMERS",		        3200,	180,    0,  60,    0,	0, 25, 20,
    (u8*)"SHIGEKI YOSHIDA",		    3200,	180,    0,  80,    1,	0, 25, 20,
    (u8*)"TAKAMITSU KUZUHARA",	    3200,	180,    0,  110,   1,	0, 25, 20,
    
    (u8*)"PROGRAMMERS",		        3500,	180,    0,  60,    0,	0, 25, 20,
    (u8*)"NOBUHIRO SUMIYOSHI",	    3500,	180,    0,  80,    1,	0, 25, 20,
    (u8*)"MAKOTO SASAKI",		    3500,	180,    0,  110,   1,	0, 25, 20,
    (u8*)"MASUMI TARUKADO",		    3500,	180,    0,  140,   1,	0, 25, 20,
    
    (u8*)"SCRIPT WRITER",		    4100,	180,    0,  60,    0,	0, 25, 20,
    (u8*)"MITSUHIRO TAKANO",		    4100,	180,    0,  80,    1,	0, 25, 20,
    
    (u8*)"CHARACTER VOICES",		    4400,	180,    0,  60,    0,	0, 25, 20,
    (u8*)"MIKE WEST",		        4400,	180,    0,  80,    1,	0, 25, 20,
    (u8*)"RICK MAY",			        4400,	180,    0,  110,   1,	0, 25, 20,
    (u8*)"LYSSA BROWNE",		        4400,	180,    0,  140,   1,	0, 25, 20,
    (u8*)"JOCK BLANEY",		        4400,	180,    0,  170,   1,	0, 25, 20,
    
    (u8*)"CHARACTER VOICES",		    4700,	180,    0,  60,    0,	0, 25, 20,
    (u8*)"DAVID WHITE",		        4700,	180,    0,  80,    1,	0, 25, 20,
    (u8*)"J. GREEN",			        4700,	180,    0,  110,   1,	0, 25, 20,
    (u8*)"BILL JOHNS",		        4700,	180,    0,  140,   1,	0, 25, 20,
    
    (u8*)"TECHNICAL SUPPORTERS",	    5050,	120,    0,  60,    0,	0, 16, 13,
    (u8*)"KENJI MATSUTANI",		    5050,	120,    0,  80,    1,	0, 16, 13,
    (u8*)"ATSUSHI NISHIWAKI",	    5050,	120,    0,  110,   1,	0, 16, 13,
    (u8*)"HIDEAKI SHIMIZU",		    5050,	120,    0,  140,   1,	0, 16, 13,
    
    (u8*)"TECHNICAL SUPPORTERS",	    5280,	120,    0,  60,    0,	0, 16, 13,
    (u8*)"YASUSHI IDA",		        5280,	120,    0,  80,    1,	0, 16, 13,
    (u8*)"HIROHITO YOSHIMOTO",	    5280,	120,    0,  110,   1,	0, 16, 13,
    (u8*)"YOSHINORI TANIMOTO",	    5280,	120,    0,  140,   1,	0, 16, 13,
    
    (u8*)"TECHNICAL SUPPORTERS",	    5510,	120,    0,  60,    0,	0, 16, 13,
    (u8*)"TAKAO SAWANO",		        5510,	120,    0,  80,    1,	0, 16, 13,
    (u8*)"HIRONOBU KAKUI",		    5510,	120,    0,  110,   1,	0, 16, 13,
    (u8*)"KENJI NISHIZAWA",		    5510,	120,    0,  140,   1,	0, 16, 13,
    
    (u8*)"TECHNICAL SUPPORTERS",	    5740,	120,    0,  60,    0,	0, 16, 13,
    (u8*)"TAKUYA KURIBAYASHI",	    5740,	120,    0,  80,    1,	0, 16, 13,
    (u8*)"TSUYOSHI TAKAHASHI",	    5740,	120,    0,  110,   1,	0, 16, 13,
    (u8*)"SHIN HASEGAWA",		    5740,	120,    0,  140,   1,	0, 16, 13,
    
    (u8*)"SUPERVISORS",		        5970,	120,    0,  60,    0,	0, 16, 13,
    (u8*)"TAKASHI TEZUKA",		    5970,	120,    0,  80,    1,	0, 16, 13,
    (u8*)"TOSHIHIKO NAKAGO",		    5970,	120,    0,  110,   1,	0, 16, 13,
    (u8*)"PROGRESS MANAGERS",	    6200,	120,    0,  60,    0,	0, 16, 13,
    (u8*)"KIMIYOSHI FUKUI",		    6200,	120,    0,  80,    1,	0, 16, 13,
    (u8*)"KEIZO KATO",		        6200,	120,    0,  110,   1,	0, 16, 13,
    
    (u8*)"SPECIAL THANKS TO",	    6430,	120,    0,  60,    0,	0, 16, 13,
    (u8*)"BENIMARU ITOH",		    6430,	120,    0,  80,    1,	0, 16, 13,
    (u8*)"SUPER MARIO CLUB",		    6430,	120,    0,  110,    1,	0, 16, 13,
    (u8*)"TRI-FILM",			        6430,	120,    0,  140,   1,	0, 16, 13,
    (u8*)"EAR FORCE",		        6430,	120,    0,  170,   1,	0, 16, 13,
    
    (u8*)"ENGLISH VERSION STAFF",	6900,	200,    0,  60,    0,	0, 25, 20,
    (u8*)"JIM WORNELL",		        6900,	200,    0,  80,    1,	0, 25, 20,
    (u8*)"KENJI OKUBO",		        6900,	200,    0,  110,   1,	0, 25, 20,
    (u8*)"GREG RICHARDSON",		    6900,	200,    0,  140,   1,	0, 25, 20,
    (u8*)"KAYOMI MCDONALD",		    6900,	200,    0,  170,   1,	0, 25, 20,
    (u8*)"EXECUTIVE PRODUCER",	    7400,	200,    0,  100,   0,	0, 25, 20,
    (u8*)"HIROSHI YAMAUCHI",		    7400,	200,    0,  120,   1,	0, 25, 20,
    
    (u8*)"NINTENDO",			        7800,	200,    0,  120,   1,	0, 25, 20,
