...
void Zoness_8018FF50(ZoEnergyBall* this) {
    ...
    x = shz_sqrtf_fsrra(SQ(gPlayer[0].cam.eye.z - (this->obj.pos.z + gPathProgress)) +
...
void Zoness_ZoBird_Update(ZoBird* this) {
    ...
    switch (this->state) {
        ...
        case 1:
            ...
            Effect_FireSmoke1_Spawn4(this->obj.pos.x, this->obj.pos.y, this->obj.pos.z, 4.0f);
...
s16 __attribute__((aligned(32))) D_i3_801BF56C[20] = {
    0, 190, 180, 170, 160, 150, 140, 130, 120, 110, 100, 90, 80, 70, 60, 50, 40, 30, 20, 10,
};
u8 __attribute__((aligned(32)))  sZoDodoraPartIdx[20] = {
...
void Zoness_ZoFish_Update(ZoFish* this) {
    ...
    switch (this->state) {
        ...
        case 3:
            ...
            Actor_Despawn(this);
            Effect_FireSmoke1_Spawn4(this->obj.pos.x, this->obj.pos.y, this->obj.pos.z, 3.0f);
...
void Zoness_ZoFish_Draw(ZoFish* this) {
    Vec3f __attribute__((aligned(32))) frameTable[20];
...
void Zoness_ZGull_Update(ZGull* this) {
    ...
    sp58 = shz_sqrtf_fsrra(SQ(sp64) + SQ(sp5C));
...
void Zoness_ZoTroika_Update(ZoTroika* this) {
    ...
    temp_fs0_2 = shz_sqrtf_fsrra(SQ(x) + SQ(z));
...
void Zoness_80193628(Object* obj, f32 arg1, f32 arg2, f32 arg3, f32 arg4, f32 arg5, f32 arg6) {
    ...
    Matrix_MultVec3fNoTranslate(gCalcMatrix, &src, &dest);
    Effect_SpawnById2(OBJ_EFFECT_ENEMY_LASER, arg1 + dest.x + arg6, arg2 + dest.y, arg3 + dest.z, arg4, arg5, 0.0f,
...
void Zoness_ZoSarumarine_Update(ZoSarumarine* this) {
    ...
    switch (this->state) {
        ...
        case 3:
            ...
            if (sZoSwork[ZO_BSS_24] != 0) {
                ...
                sp110 = Math_Atan2F(spC0.y, shz_sqrtf_fsrra(SQ(spC0.x) + SQ(spC0.z)));
                ...
                sp108 = Math_Atan2F(spB4.y, shz_sqrtf_fsrra(SQ(spB4.x) + SQ(spB4.z)));
    ...
    if ((this->state >= 3) && (this->state < 6)) {
        ...
        sp120 = Math_Atan2F(spD8.y, shz_sqrtf_fsrra(SQ(spD8.x) + SQ(spD8.z)));
        ...
        sp118 = Math_Atan2F(spCC.y, shz_sqrtf_fsrra(SQ(spCC.x) + SQ(spCC.z)));
    ...
    if ((sZoSwork[ZO_BSS_8] == 0) && (sZoLimbTimers[ZO_LIMB_15] != LIMB_DESTROYED)) {
        if ((sZoFwork[ZO_BSF_87] < -570.0f) || (sZoFwork[ZO_BSF_88] > 1600.0f)) {
            ...
            Effect_FireSmoke1_Spawn4(sZoFwork[ZO_BSF_43_X], sZoFwork[ZO_BSF_43_Y], sZoFwork[ZO_BSF_43_Z], 5.0f);
    ...
    if ((sZoSwork[ZO_BSS_9] == 0) && (sZoLimbTimers[ZO_LIMB_10] != LIMB_DESTROYED)) {
        if ((sZoFwork[ZO_BSF_81] > 700.0f) || (sZoFwork[ZO_BSF_82] < -400.0f)) {
            ...
            Effect_FireSmoke1_Spawn4(sZoFwork[ZO_BSF_29_X], sZoFwork[ZO_BSF_29_Y], sZoFwork[ZO_BSF_29_Z], 5.0f);
    ...
    if ((sZoSwork[ZO_BSS_10] == 0) && (sZoLimbTimers[ZO_LIMB_2] != LIMB_DESTROYED)) {
        if ((sZoFwork[ZO_BSF_84] > 700.0f) || (sZoFwork[ZO_BSF_85] < -400.0f)) {
            ...
            Effect_FireSmoke1_Spawn4(sZoFwork[ZO_BSF_32_X], sZoFwork[ZO_BSF_32_Y], sZoFwork[ZO_BSF_32_Z], 5.0f);
    ...
    if ((sZoSwork[ZO_BSS_13] < 2) && (sZoLimbTimers[ZO_LIMB_5] != LIMB_DESTROYED)) {
        D_ctx_801779A8[0] = 20;
        if ((gGameFrameCount % 2) == 0) {
            Effect_FireSmoke1_Spawn4(sZoFwork[ZO_BSF_52_X] + RAND_FLOAT_CENTERED(200.0f),
        ...
        if (this->swork[ZO_SWK_14] != 0) {
            ...
            if ((sZoFwork[ZO_BSF_92] < -700.0f) || (sZoFwork[ZO_BSF_91] < -400.0f)) {
                ...
                Effect_FireSmoke1_Spawn4(sZoFwork[ZO_BSF_52_X], sZoFwork[ZO_BSF_52_Y], sZoFwork[ZO_BSF_52_Z], 5.0f);
            ...
            case 3:
                if ((sZoSwork[ZO_BSS_9] != 0) && (this->state == 3) && (dmgType == DMG_BOMB) &&
                    ...
                    if (sZoSwork[ZO_BSS_9] <= 0) {
                        ...
                        Effect_TimedSfx_Spawn(&spD8, NA_SE_EN_EXPLOSION_S);
                    }
                }
                break;
            ...
            case 12:
                if ((sZoSwork[ZO_BSS_13] >= 2) && (this->state == 5) && (dmgType == DMG_BOMB)) {
                    ...
                    if (sZoSwork[ZO_BSS_13] < 2) {
                        ...
                        Effect_TimedSfx_Spawn(&spD8, NA_SE_EN_SINK_PARTS);
                    }
                }
                break;
            ...
            case 10 + 1:
                if ((sZoSwork[ZO_BSS_12] != 0) && (this->state == 3) && (dmgType == DMG_BOMB) &&
                    ...
                    if (sZoSwork[ZO_BSS_12] <= 0) {
                        ...
                        Effect_TimedSfx_Spawn(&spCC, NA_SE_EN_SINK_PARTS);
    ...
    if (this->state < 4) {
        ...
        if (((sZoSwork[ZO_BSS_53] % 2) != 0) && (sZoSwork[ZO_BSS_11] != 0)) {
            Effect_TimedSfx_Spawn(&spD8, NA_SE_OB_DAMAGE_M);
        }
        if (((sZoSwork[ZO_BSS_54] % 2) != 0) && (sZoSwork[ZO_BSS_12] != 0)) {
            Effect_TimedSfx_Spawn(&spCC, NA_SE_OB_DAMAGE_M);
        }
    }
    ...
    if ((sZoSwork[ZO_BSS_50] % 2) != 0) {
        ...
        spD8.y = sZoFwork[ZO_BSF_29_Y];
        spD8.z = sZoFwork[ZO_BSF_29_Z];
        Effect_TimedSfx_Spawn(&spD8, NA_SE_EN_DAMAGE_S);
    }
    ...
    if (Play_CheckDynaFloorCollision(&sp134, &sp130, this->obj.pos.x, this->obj.pos.y - 500.0f, this->obj.pos.z) != 0) {
        ...
        this->fwork[ZO_FWK_1] = SIN_DEG(gGameFrameCount * 7.0f);
    ...
    if (gBossFrameCount > 686) {
        gBossHealthBar = this->health*0.21333333f;/// 300.0f * 64.0f;
        gBossHealthBar += (s32) ((sZoSwork[ZO_BSS_11]*3.2f));// / 20.0f) * 64.0f);
        gBossHealthBar += (s32) ((sZoSwork[ZO_BSS_12]*3.2f));// / 20.0f) * 64.0f);
        gBossHealthBar += (s32) ((sZoSwork[ZO_BSS_9]*0.4f));/// (20.0f * 2)) * 16.0f);
        gBossHealthBar += (s32) ((sZoSwork[ZO_BSS_10]*0.4f));// / (20.0f * 2)) * 16.0f);
        gBossHealthBar += (s32) ((sZoSwork[ZO_BSS_13]*0.50819672f));// / 61.0f) * 31.0f);
    }
...
void Zoness_ZoBall_Update(ZoBall* this) {
    ...
    if ((this->dmgType != DMG_NONE) && (this->health != 0)) {
        ...
        if (this->health <= 0) {
            ...
            Effect_FireSmoke1_Spawn4(this->obj.pos.x, this->obj.pos.y, this->obj.pos.z + 200.0f, 5.0f);
            this->itemDrop = DROP_BOMB;
...
void Zoness_FlamePillar_Setup(EffectFlamePillar* this, f32 xPos, f32 yPos, f32 zPos) {
    ...
    Effect_FireSmoke1_Spawn4(xPos, yPos + 30.0f, zPos, 7.0f);
    Effect_Effect386_Spawn1(this->obj.pos.x, this->obj.pos.y + 30.0f, this->obj.pos.z, 0.0f, 0.0f, 0.0f, 4.0f, 5);
    Object_SetInfo(&this->info, this->obj.id);
}

void Zoness_FlamePillar_Spawn(f32 xPos, f32 yPos, f32 zPos) {
    s32 i;

    for (i = 0; i < ARRAY_COUNT(gEffects); i++) {
        if (gEffects[i].obj.status == OBJ_FREE) {
            Zoness_FlamePillar_Setup(&gEffects[i], xPos, yPos, zPos);
            break;
        }
    }
}
    ...
    switch (this->state) {
        ...
        case 2:
            ...
            if ((this->dmgType != DMG_NONE) && (this->health != 0)) {
                ...
                Effect_FireSmoke1_Spawn4(this->obj.pos.x, this->obj.pos.y + 100.0f, this->obj.pos.z, 7.0f);
                this->dmgSource = DMG_SRC_2;
                ...
                if ((fabsf(this->obj.pos.z - gPlayer[0].trueZpos) < 800.0f) || (this->dmgType != DMG_NONE)) {
                    Zoness_FlamePillar_Spawn(this->obj.pos.x, this->obj.pos.y, this->obj.pos.z);
                    Object_Kill(&this->obj, this->sfxSource);
...
void Zoness_ZoCraneMagnet_Draw(ZoCraneMagnet* this) {
    ...
    for (j = 0; j < i; j++) {
        ...
        Matrix_RotateY(gGfxMatrix, F_PI_2, MTXF_APPLY);
        Matrix_Push(&gGfxMatrix);
    ...
    switch (this->state) {
        case 0:
            ...
            if ((sZoSwork[ZO_BSS_20] != 0) && (this->timer_0BC == 0)) {
                ...
                this->timer_0BC = (s32) ((fabsf(sZoFwork[ZO_BSF_28] - -2600.0f) * 0.01f) + 30.0f);
                this->timer_0C0 = 3;
...
void Zoness_ZoSpikeBall_Draw(ZoSpikeBall* this) {
    ...
    if ((gBosses[0].state != 6) && (gBosses[0].state != 7)) {
        ...
        sp94 = (180.0f  * recip_var_s4/* / var_s4 */) + 1.0f;
...
void Zoness_ZoTanker_Init(ZoTanker* actor) {
    ...
    if (actor->obj.rot.x >= 100.0f) {
        actor->state = 1;
        actor->iwork[3] = actor->obj.rot.x * 0.01f;/// 100.0f;
...
void Zoness_ZoContainer_Update(ZoContainer* this) {
    ...
    switch (this->state) {
        ...
        case 1:
            ...
            for (i = 0; i < 3; i++) {
                Effect_FireSmoke1_Spawn4(this->obj.pos.x + RAND_FLOAT_CENTERED(50.0f),
            ...
            if (sZoContainerItemDrops[this->iwork[0]] < 1000) {
                ...
                if (sZoContainerItemDrops[this->iwork[0]] == 1000) {
                    for (i = 0, j = 0; i < 10; i++, j++) {
                        ...
                        sp9C.z = 50.0f;
                        Effect_SpawnById1(OBJ_EFFECT_ENEMY_LASER, &spB4, &spA8, &spA8, &sp9C, 1.0f);
                    }
                }
                this->itemDrop = DROP_NONE;
                Actor_Despawn(this);
            ...
            Object_Kill(&this->obj, this->sfxSource);
            Effect_TimedSfx_Spawn(&this->obj.pos, NA_SE_OB_BROKEN_BOX);
            break;
    }
}
...
void Zoness_ZoRadarBuoy_Update(ZoRadarBuoy* this) {
    ...
    switch (this->state) {
        ...
        case 2:
            ...
            Effect_FireSmoke1_Spawn4(this->obj.pos.x, this->obj.pos.y + 50.0f, this->obj.pos.z, 5.0f);
            Object_Kill(&this->obj, this->sfxSource);
            Effect_TimedSfx_Spawn(&this->obj.pos, NA_SE_EN_WT_EXPLOSION_S);
            break;
    }
...
void Zoness_ZoSupplyCrane_Init(ZoSupplyCrane* this) {
    ...
    if (this->state != 3) {
        ...
        sp38 = fabsf(this->obj.rot.z *0.1f);// / 10.0f);
    } else {
        sp38 = this->iwork[0];
        this->state = 0;
    }
