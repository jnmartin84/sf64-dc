    ...
    //                  TEXEL0, PRIMITIVE, PRIMITIVE, 0, TEXEL0, 0);
                        ...
                        case LEVEL_METEO:
                            if ((gPlayer[0].state == PLAYERSTATE_LEVEL_COMPLETE) && (gCsFrameCount > 260)) {
                                Matrix_Translate(gGfxMatrix, (bgXpos - 120.0f)* 41.0f, (-(bgYpos - 120.0f) - 30.0f)* 41.0f, -290.0f* 41.0f,
                                                 MTXF_APPLY);
...
Gfx twotri_aZoWater1DL[] = {
    ...
    gsDPSetTextureImage(G_IM_FMT_RGBA, G_IM_SIZ_16b, 1, aZoWaterTex),
    gsDPTileSync(),
    ...
    gsSPVertex(&D_ZO_6009ED0[6], 2, 0),
    gsSPVertex(&D_ZO_6009ED0[9], 3, 2),
    gsSPVertex(&D_ZO_6009ED0[13], 9, 5),
    gsSPVertex(&D_ZO_6009ED0[56], 1, 14),
    gsSP2Triangles(1, 0, 5, 0, 1, 5, 7, 0),
    gsSP2Triangles(2, 8, 9, 0, 2, 9, 3, 0),
    gsSP2Triangles(3, 9, 10, 0, 3, 10, 4, 0),
    gsSP2Triangles(4, 10, 14, 0, 4, 14, 6, 0),
    gsSP2Triangles(8, 11, 12, 0, 8, 12, 9, 0),
    gsSP2Triangles(9, 12, 13, 0, 9, 13, 10, 0),
    gsSPVertex(&D_ZO_6009ED0[18], 10, 0),
    gsSPVertex(&D_ZO_6009ED0[56], 4, 10),
    gsSP2Triangles(0, 3, 11, 0, 0, 11, 10, 0),
    gsSP2Triangles(1, 4, 5, 0, 1, 5, 2, 0),
    gsSP2Triangles(2, 5, 6, 0, 2, 6, 3, 0),
    gsSP2Triangles(3, 6, 12, 0, 3, 12, 11, 0),
    gsSP2Triangles(4, 7, 8, 0, 4, 8, 5, 0),
    gsSP2Triangles(5, 8, 9, 0, 5, 9, 6, 0),
    gsSP2Triangles(6, 9, 13, 0, 6, 13, 12, 0),
    gsSPVertex(D_ZO_6009ED0, 1, 0),
    gsSPVertex(&D_ZO_6009ED0[3], 1, 1),
    gsSPVertex(&D_ZO_6009ED0[7], 1, 2),
    gsSPVertex(&D_ZO_6009ED0[25], 6, 3),
    gsSPVertex(&D_ZO_6009ED0[59], 1, 9),
    gsSPVertex(&D_ZO_6009ED0[256], 4, 10),
    gsSP2Triangles(3, 10, 11, 0, 3, 11, 4, 0),
    gsSP2Triangles(4, 11, 12, 0, 4, 12, 5, 0),
    gsSP2Triangles(5, 12, 13, 0, 5, 13, 9, 0),
    gsSP2Triangles(6, 0, 1, 0, 6, 1, 7, 0),
    gsSP2Triangles(7, 1, 2, 0, 7, 2, 8, 0),
    gsSPVertex(&D_ZO_6009ED0[7], 1, 0),
    gsSPVertex(&D_ZO_6009ED0[15], 1, 1),
    gsSPVertex(&D_ZO_6009ED0[30], 13, 2),
    gsSPVertex(&D_ZO_6009ED0[60], 1, 15),
    gsSP2Triangles(2, 0, 1, 0, 2, 1, 15, 0),
    gsSP2Triangles(3, 4, 6, 0, 3, 6, 5, 0),
    gsSP2Triangles(4, 7, 8, 0, 4, 8, 6, 0),
    gsSP2Triangles(5, 6, 9, 0, 5, 9, 11, 0),
    gsSP2Triangles(6, 8, 10, 0, 6, 10, 9, 0),
    gsSP2Triangles(7, 12, 13, 0, 7, 13, 8, 0),
    gsSP2Triangles(8, 13, 14, 0, 8, 14, 10, 0),
    gsSPVertex(&D_ZO_6009ED0[37], 9, 0),
    gsSPVertex(&D_ZO_6009ED0[52], 2, 9),
    gsSPVertex(&D_ZO_6009ED0[61], 3, 11),
    gsSP2Triangles(0, 1, 11, 0, 0, 11, 10, 0),
    gsSP2Triangles(1, 5, 12, 0, 1, 12, 11, 0),
    gsSP2Triangles(2, 0, 10, 0, 2, 10, 9, 0),
    gsSP2Triangles(3, 6, 7, 0, 3, 7, 4, 0),
    gsSP2Triangles(4, 7, 8, 0, 4, 8, 5, 0),
    gsSP2Triangles(5, 8, 13, 0, 5, 13, 12, 0),
    gsSPVertex(&D_ZO_6009ED0[28], 3, 0),
    gsSPVertex(&D_ZO_6009ED0[43], 9, 3),
    gsSPVertex(&D_ZO_6009ED0[63], 3, 12),
    gsSP2Triangles(3, 6, 7, 0, 3, 7, 4, 0),
    gsSP2Triangles(4, 7, 8, 0, 4, 8, 5, 0),
    gsSP2Triangles(5, 8, 13, 0, 5, 13, 12, 0),
    gsSP2Triangles(6, 9, 10, 0, 6, 10, 7, 0),
    gsSP2Triangles(7, 10, 11, 0, 7, 11, 8, 0),
    gsSP2Triangles(8, 11, 14, 0, 8, 14, 13, 0),
    gsSP2Triangles(9, 0, 1, 0, 9, 1, 10, 0),
    gsSP2Triangles(10, 1, 2, 0, 10, 2, 11, 0),
    gsSPVertex(&D_ZO_6009ED0[12], 3, 0),
    gsSPVertex(&D_ZO_6009ED0[30], 1, 3),
    gsSPVertex(&D_ZO_6009ED0[51], 5, 4),
    gsSPVertex(&D_ZO_6009ED0[60], 2, 9),
    gsSPVertex(&D_ZO_6009ED0[65], 1, 11),
    gsSPVertex(&D_ZO_6009ED0[98], 3, 12),
    gsSPVertex(&D_ZO_6009ED0[127], 1, 15),
    gsSP2Triangles(4, 3, 9, 0, 4, 9, 11, 0),
    gsSP2Triangles(5, 6, 13, 0, 5, 13, 12, 0),
    gsSP2Triangles(6, 10, 15, 0, 6, 15, 13, 0),
    gsSP2Triangles(0, 2, 7, 0, 0, 7, 8, 0),
    gsSP2Triangles(1, 0, 8, 0, 1, 8, 14, 0),
    gsSPVertex(&D_ZO_6009ED0[13], 3, 0),
    gsSPVertex(&D_ZO_6009ED0[54], 1, 3),
    gsSPVertex(&D_ZO_6009ED0[56], 4, 4),
    gsSPVertex(&D_ZO_6009ED0[100], 2, 8),
    gsSPVertex(&D_ZO_6009ED0[110], 1, 10),
    gsSPVertex(&D_ZO_6009ED0[113], 1, 11),
    gsSPVertex(&D_ZO_6009ED0[116], 1, 12),
    gsSPVertex(&D_ZO_6009ED0[119], 1, 13),
    gsSP2Triangles(2, 0, 8, 0, 2, 8, 9, 0),
    gsSP2Triangles(1, 4, 10, 0, 1, 10, 3, 0),
    gsSP2Triangles(4, 5, 11, 0, 4, 11, 10, 0),
    gsSP2Triangles(5, 6, 12, 0, 5, 12, 11, 0),
    gsSP2Triangles(6, 7, 13, 0, 6, 13, 12, 0),
    gsSPVertex(&D_ZO_6009ED0[15], 1, 0),
    gsSPVertex(&D_ZO_6009ED0[59], 5, 1),
    gsSPVertex(&D_ZO_6009ED0[101], 1, 6),
    gsSPVertex(&D_ZO_6009ED0[119], 1, 7),
    gsSPVertex(&D_ZO_6009ED0[122], 1, 8),
    gsSPVertex(&D_ZO_6009ED0[127], 1, 9),
    gsSPVertex(&D_ZO_6009ED0[132], 1, 10),
    gsSPVertex(&D_ZO_6009ED0[135], 1, 11),
    gsSPVertex(&D_ZO_6009ED0[259], 2, 12),
    gsSP2Triangles(1, 12, 13, 0, 1, 13, 7, 0),
    gsSP2Triangles(2, 0, 6, 0, 2, 6, 8, 0),
    gsSP2Triangles(3, 4, 10, 0, 3, 10, 9, 0),
    gsSP2Triangles(4, 5, 11, 0, 4, 11, 10, 0),
    gsSPVertex(D_ZO_6009ED0, 2, 0),
    gsSPVertex(&D_ZO_6009ED0[60], 1, 2),
    gsSPVertex(&D_ZO_6009ED0[63], 9, 3),
    gsSPVertex(&D_ZO_6009ED0[122], 1, 12),
    gsSPVertex(&D_ZO_6009ED0[135], 1, 13),
    gsSPVertex(&D_ZO_6009ED0[138], 1, 14),
    gsSPVertex(&D_ZO_6009ED0[141], 1, 15),
    gsSP2Triangles(3, 4, 14, 0, 3, 14, 13, 0),
    gsSP2Triangles(4, 5, 15, 0, 4, 15, 14, 0),
    gsSP2Triangles(5, 2, 12, 0, 5, 12, 15, 0),
    gsSP2Triangles(6, 10, 11, 0, 6, 11, 9, 0),
    gsSP2Triangles(7, 6, 9, 0, 7, 9, 8, 0),
    gsSP2Triangles(8, 9, 1, 0, 8, 1, 0, 0),
    gsSPVertex(&D_ZO_6009ED0[1], 1, 0),
    gsSPVertex(&D_ZO_6009ED0[4], 1, 1),
    gsSPVertex(&D_ZO_6009ED0[9], 1, 2),
    gsSPVertex(&D_ZO_6009ED0[16], 1, 3),
    gsSPVertex(&D_ZO_6009ED0[19], 1, 4),
    gsSPVertex(&D_ZO_6009ED0[69], 9, 5),
    gsSP2Triangles(6, 8, 9, 0, 6, 9, 7, 0),
    gsSP2Triangles(5, 7, 1, 0, 5, 1, 0, 0),
    gsSP2Triangles(7, 9, 2, 0, 7, 2, 1, 0),
    gsSP2Triangles(8, 10, 11, 0, 8, 11, 9, 0),
    gsSP2Triangles(9, 11, 3, 0, 9, 3, 2, 0),
    gsSP2Triangles(10, 12, 13, 0, 10, 13, 11, 0),
    gsSP2Triangles(11, 13, 4, 0, 11, 4, 3, 0),
    gsSPVertex(&D_ZO_6009ED0[19], 1, 0),
    gsSPVertex(&D_ZO_6009ED0[22], 1, 1),
    gsSPVertex(&D_ZO_6009ED0[25], 1, 2),
    gsSPVertex(&D_ZO_6009ED0[67], 2, 3),
    gsSPVertex(&D_ZO_6009ED0[76], 8, 5),
    gsSPVertex(&D_ZO_6009ED0[256], 1, 13),
    gsSPVertex(&D_ZO_6009ED0[262], 2, 14),
    gsSP2Triangles(5, 7, 8, 0, 5, 8, 6, 0),
    gsSP2Triangles(6, 8, 1, 0, 6, 1, 0, 0),
    gsSP2Triangles(7, 9, 10, 0, 7, 10, 8, 0),
    gsSP2Triangles(8, 10, 2, 0, 8, 2, 1, 0),
    gsSP2Triangles(9, 14, 15, 0, 9, 15, 10, 0),
    gsSP2Triangles(10, 15, 13, 0, 10, 13, 2, 0),
    gsSP2Triangles(11, 3, 4, 0, 11, 4, 12, 0),
    gsSPVertex(D_ZO_6009ED0, 1, 0),
    gsSPVertex(&D_ZO_6009ED0[28], 1, 1),
    gsSPVertex(&D_ZO_6009ED0[31], 2, 2),
    gsSPVertex(&D_ZO_6009ED0[35], 1, 4),
    gsSPVertex(&D_ZO_6009ED0[40], 1, 5),
    gsSPVertex(&D_ZO_6009ED0[68], 1, 6),
    gsSPVertex(&D_ZO_6009ED0[83], 9, 7),
    gsSP2Triangles(7, 6, 0, 0, 7, 0, 1, 0),
    gsSP2Triangles(8, 9, 10, 0, 8, 10, 11, 0),
    gsSP2Triangles(9, 12, 13, 0, 9, 13, 10, 0),
    gsSP2Triangles(10, 13, 4, 0, 10, 4, 3, 0),
    gsSP2Triangles(11, 10, 3, 0, 11, 3, 2, 0),
    gsSP2Triangles(12, 14, 15, 0, 12, 15, 13, 0),
    gsSP2Triangles(13, 15, 5, 0, 13, 5, 4, 0),
    gsSPVertex(&D_ZO_6009ED0[28], 1, 0),
    gsSPVertex(&D_ZO_6009ED0[40], 1, 1),
    gsSPVertex(&D_ZO_6009ED0[43], 1, 2),
    gsSPVertex(&D_ZO_6009ED0[46], 1, 3),
    gsSPVertex(&D_ZO_6009ED0[49], 1, 4),
    gsSPVertex(&D_ZO_6009ED0[82], 2, 5),
    gsSPVertex(&D_ZO_6009ED0[90], 8, 7),
    gsSP2Triangles(7, 9, 10, 0, 7, 10, 8, 0),
    gsSP2Triangles(8, 10, 2, 0, 8, 2, 1, 0),
    gsSP2Triangles(9, 11, 12, 0, 9, 12, 10, 0),
    gsSP2Triangles(10, 12, 3, 0, 10, 3, 2, 0),
    gsSP2Triangles(11, 13, 14, 0, 11, 14, 12, 0),
    gsSP2Triangles(12, 14, 4, 0, 12, 4, 3, 0),
    gsSP2Triangles(13, 5, 6, 0, 13, 6, 14, 0),
    gsSP2Triangles(14, 6, 0, 0, 14, 0, 4, 0),
    gsSPVertex(&D_ZO_6009ED0[55], 1, 0),
    gsSPVertex(&D_ZO_6009ED0[98], 10, 1),
    gsSPVertex(&D_ZO_6009ED0[125], 4, 11),
    gsSP2Triangles(1, 2, 11, 0, 1, 11, 12, 0),
    gsSP2Triangles(2, 13, 14, 0, 2, 14, 11, 0),
    gsSP2Triangles(3, 0, 7, 0, 3, 7, 6, 0),
    gsSP2Triangles(4, 3, 6, 0, 4, 6, 5, 0),
    gsSP2Triangles(5, 6, 8, 0, 5, 8, 10, 0),
    gsSP2Triangles(6, 7, 9, 0, 6, 9, 8, 0),
    gsSPVertex(&D_ZO_6009ED0[54], 2, 0),
    gsSPVertex(&D_ZO_6009ED0[104], 9, 2),
    gsSPVertex(&D_ZO_6009ED0[264], 4, 11),
    gsSP2Triangles(1, 0, 6, 0, 1, 6, 2, 0),
    gsSP2Triangles(2, 6, 7, 0, 2, 7, 4, 0),
    gsSP2Triangles(3, 4, 11, 0, 3, 11, 12, 0),
    gsSP2Triangles(4, 7, 13, 0, 4, 13, 11, 0),
    gsSP2Triangles(5, 3, 12, 0, 5, 12, 14, 0),
    gsSP2Triangles(0, 8, 9, 0, 0, 9, 6, 0),
    gsSP2Triangles(6, 9, 10, 0, 6, 10, 7, 0),
    gsSPVertex(&D_ZO_6009ED0[109], 10, 0),
    gsSPVertex(&D_ZO_6009ED0[266], 1, 10),
    gsSPVertex(&D_ZO_6009ED0[268], 3, 11),
    gsSP2Triangles(0, 3, 11, 0, 0, 11, 10, 0),
    gsSP2Triangles(1, 4, 5, 0, 1, 5, 2, 0),
    gsSP2Triangles(2, 5, 6, 0, 2, 6, 3, 0),
    gsSP2Triangles(3, 6, 12, 0, 3, 12, 11, 0),
    ...
    gsSP2Triangles(5, 8, 9, 0, 5, 9, 6, 0),
    gsSP2Triangles(6, 9, 13, 0, 6, 13, 12, 0),
    gsSPVertex(&D_ZO_6009ED0[101], 2, 0),
    gsSPVertex(&D_ZO_6009ED0[116], 8, 2),
    gsSPVertex(&D_ZO_6009ED0[260], 2, 10),
    gsSPVertex(&D_ZO_6009ED0[270], 4, 12),
    gsSP2Triangles(2, 5, 6, 0, 2, 6, 3, 0),
    gsSP2Triangles(3, 6, 7, 0, 3, 7, 4, 0),
    gsSP2Triangles(4, 7, 13, 0, 4, 13, 12, 0),
    gsSP2Triangles(5, 10, 11, 0, 5, 11, 6, 0),
    gsSP2Triangles(6, 11, 14, 0, 6, 14, 7, 0),
    gsSP2Triangles(7, 14, 15, 0, 7, 15, 13, 0),
    gsSP2Triangles(8, 0, 1, 0, 8, 1, 9, 0),
    gsSPVertex(&D_ZO_6009ED0[102], 1, 0),
    gsSPVertex(&D_ZO_6009ED0[107], 1, 1),
    gsSPVertex(&D_ZO_6009ED0[123], 12, 2),
    gsSPVertex(&D_ZO_6009ED0[267], 1, 14),
    gsSPVertex(&D_ZO_6009ED0[274], 1, 15),
    gsSP2Triangles(2, 0, 1, 0, 2, 1, 3, 0),
    gsSP2Triangles(3, 1, 14, 0, 3, 14, 15, 0),
    gsSP2Triangles(4, 7, 8, 0, 4, 8, 9, 0),
    gsSP2Triangles(5, 4, 9, 0, 5, 9, 10, 0),
    gsSP2Triangles(6, 11, 12, 0, 6, 12, 7, 0),
    gsSP2Triangles(7, 12, 13, 0, 7, 13, 8, 0),
    gsSPVertex(&D_ZO_6009ED0[129], 9, 0),
    gsSPVertex(&D_ZO_6009ED0[275], 5, 9),
    gsSP2Triangles(0, 5, 9, 0, 0, 9, 10, 0),
    gsSP2Triangles(1, 0, 10, 0, 1, 10, 11, 0),
    gsSP2Triangles(2, 1, 11, 0, 2, 11, 12, 0),
    gsSP2Triangles(3, 6, 7, 0, 3, 7, 4, 0),
    gsSP2Triangles(4, 7, 8, 0, 4, 8, 5, 0),
    gsSP2Triangles(5, 8, 13, 0, 5, 13, 9, 0),
    gsSPVertex(&D_ZO_6009ED0[122], 3, 0),
    gsSPVertex(&D_ZO_6009ED0[135], 9, 3),
    gsSPVertex(&D_ZO_6009ED0[279], 3, 12),
    gsSP2Triangles(3, 6, 7, 0, 3, 7, 4, 0),
    gsSP2Triangles(4, 7, 8, 0, 4, 8, 5, 0),
    gsSP2Triangles(5, 8, 13, 0, 5, 13, 12, 0),
    gsSP2Triangles(6, 9, 10, 0, 6, 10, 7, 0),
    ...
    gsSP2Triangles(9, 0, 1, 0, 9, 1, 10, 0),
    gsSP2Triangles(10, 1, 2, 0, 10, 2, 11, 0),
    gsSPVertex(&D_ZO_6009ED0[124], 1, 0),
    gsSPVertex(&D_ZO_6009ED0[143], 13, 1),
    gsSPVertex(&D_ZO_6009ED0[274], 1, 14),
    gsSPVertex(&D_ZO_6009ED0[281], 1, 15),
    ...
    gsSPVertex(&D_ZO_6009ED0[150], 9, 0),
    gsSPVertex(&D_ZO_6009ED0[192], 5, 9),
    gsSP2Triangles(0, 1, 9, 0, 0, 9, 10, 0),
    gsSP2Triangles(1, 5, 12, 0, 1, 12, 9, 0),
    gsSP2Triangles(2, 0, 10, 0, 2, 10, 11, 0),
    gsSP2Triangles(3, 6, 7, 0, 3, 7, 4, 0),
    gsSP2Triangles(4, 7, 8, 0, 4, 8, 5, 0),
    gsSP2Triangles(5, 8, 13, 0, 5, 13, 12, 0),
    gsSPVertex(&D_ZO_6009ED0[156], 12, 0),
    gsSPVertex(&D_ZO_6009ED0[196], 3, 12),
    gsSP2Triangles(0, 3, 4, 0, 0, 4, 1, 0),
    gsSP2Triangles(1, 4, 5, 0, 1, 5, 2, 0),
    gsSP2Triangles(2, 5, 13, 0, 2, 13, 12, 0),
    gsSP2Triangles(3, 6, 7, 0, 3, 7, 4, 0),
    gsSP2Triangles(4, 7, 8, 0, 4, 8, 5, 0),
    gsSP2Triangles(5, 8, 14, 0, 5, 14, 13, 0),
    gsSP2Triangles(6, 9, 10, 0, 6, 10, 7, 0),
    gsSP2Triangles(7, 10, 11, 0, 7, 11, 8, 0),
    gsSPVertex(&D_ZO_6009ED0[164], 7, 0),
    gsSPVertex(&D_ZO_6009ED0[198], 3, 7),
    gsSPVertex(&D_ZO_6009ED0[282], 4, 10),
    gsSP2Triangles(0, 3, 8, 0, 0, 8, 7, 0),
    gsSP2Triangles(1, 5, 4, 0, 1, 4, 2, 0),
    gsSP2Triangles(2, 4, 6, 0, 2, 6, 3, 0),
    gsSP2Triangles(3, 6, 9, 0, 3, 9, 8, 0),
    gsSP2Triangles(4, 10, 11, 0, 4, 11, 6, 0),
    gsSP2Triangles(5, 12, 10, 0, 5, 10, 4, 0),
    gsSP2Triangles(6, 11, 13, 0, 6, 13, 9, 0),
    gsSPVertex(&D_ZO_6009ED0[145], 2, 0),
    gsSPVertex(&D_ZO_6009ED0[152], 1, 2),
    gsSPVertex(&D_ZO_6009ED0[171], 9, 3),
    gsSPVertex(&D_ZO_6009ED0[194], 1, 12),
    gsSPVertex(&D_ZO_6009ED0[201], 1, 13),
    gsSP2Triangles(3, 0, 1, 0, 3, 1, 4, 0),
    gsSP2Triangles(4, 1, 2, 0, 4, 2, 5, 0),
    gsSP2Triangles(5, 2, 12, 0, 5, 12, 13, 0),
    gsSP2Triangles(6, 8, 9, 0, 6, 9, 7, 0),
    gsSP2Triangles(7, 9, 10, 0, 7, 10, 11, 0),
    gsSPVertex(&D_ZO_6009ED0[176], 10, 0),
    gsSPVertex(&D_ZO_6009ED0[202], 4, 10),
    gsSP2Triangles(0, 4, 5, 0, 0, 5, 1, 0),
    gsSP2Triangles(1, 5, 6, 0, 1, 6, 2, 0),
    gsSP2Triangles(2, 6, 12, 0, 2, 12, 10, 0),
    gsSP2Triangles(3, 2, 10, 0, 3, 10, 11, 0),
    gsSP2Triangles(4, 7, 8, 0, 4, 8, 5, 0),
    gsSP2Triangles(5, 8, 9, 0, 5, 9, 6, 0),
    gsSP2Triangles(6, 9, 13, 0, 6, 13, 12, 0),
    gsSPVertex(&D_ZO_6009ED0[171], 3, 0),
    gsSPVertex(&D_ZO_6009ED0[183], 9, 3),
    gsSPVertex(&D_ZO_6009ED0[205], 3, 12),
    gsSP2Triangles(3, 6, 7, 0, 3, 7, 4, 0),
    gsSP2Triangles(4, 7, 8, 0, 4, 8, 5, 0),
    gsSP2Triangles(5, 8, 13, 0, 5, 13, 12, 0),
    gsSP2Triangles(6, 9, 10, 0, 6, 10, 7, 0),
    ...
    gsSP2Triangles(9, 0, 1, 0, 9, 1, 10, 0),
    gsSP2Triangles(10, 1, 2, 0, 10, 2, 11, 0),
    gsSPVertex(&D_ZO_6009ED0[173], 1, 0),
    gsSPVertex(&D_ZO_6009ED0[191], 6, 1),
    gsSPVertex(&D_ZO_6009ED0[201], 1, 7),
    gsSPVertex(&D_ZO_6009ED0[207], 1, 8),
    gsSPVertex(&D_ZO_6009ED0[225], 2, 9),
    gsSPVertex(&D_ZO_6009ED0[228], 1, 11),
    gsSPVertex(&D_ZO_6009ED0[230], 1, 12),
    gsSPVertex(&D_ZO_6009ED0[240], 1, 13),
    gsSP2Triangles(1, 0, 7, 0, 1, 7, 8, 0),
    gsSP2Triangles(2, 5, 11, 0, 2, 11, 9, 0),
    gsSP2Triangles(3, 2, 9, 0, 3, 9, 10, 0),
    gsSP2Triangles(4, 3, 10, 0, 4, 10, 13, 0),
    gsSP2Triangles(5, 6, 12, 0, 5, 12, 11, 0),
    gsSPVertex(&D_ZO_6009ED0[194], 1, 0),
    gsSPVertex(&D_ZO_6009ED0[196], 6, 1),
    gsSPVertex(&D_ZO_6009ED0[230], 1, 7),
    gsSPVertex(&D_ZO_6009ED0[232], 1, 8),
    gsSPVertex(&D_ZO_6009ED0[234], 1, 9),
    gsSPVertex(&D_ZO_6009ED0[236], 1, 10),
    gsSPVertex(&D_ZO_6009ED0[238], 1, 11),
    gsSPVertex(&D_ZO_6009ED0[240], 1, 12),
    gsSPVertex(&D_ZO_6009ED0[254], 1, 13),
    gsSPVertex(&D_ZO_6009ED0[285], 2, 14),
    gsSP2Triangles(1, 2, 8, 0, 1, 8, 7, 0),
    gsSP2Triangles(2, 3, 9, 0, 2, 9, 8, 0),
    gsSP2Triangles(3, 4, 10, 0, 3, 10, 9, 0),
    gsSP2Triangles(4, 5, 11, 0, 4, 11, 10, 0),
    gsSP2Triangles(5, 14, 15, 0, 5, 15, 11, 0),
    gsSP2Triangles(6, 0, 12, 0, 6, 12, 13, 0),
    gsSPVertex(&D_ZO_6009ED0[201], 7, 0),
    gsSPVertex(&D_ZO_6009ED0[242], 2, 7),
    gsSPVertex(&D_ZO_6009ED0[246], 1, 9),
    gsSPVertex(&D_ZO_6009ED0[248], 1, 10),
    gsSPVertex(&D_ZO_6009ED0[250], 1, 11),
    gsSPVertex(&D_ZO_6009ED0[252], 1, 12),
    gsSPVertex(&D_ZO_6009ED0[254], 1, 13),
    gsSP2Triangles(1, 3, 9, 0, 1, 9, 7, 0),
    gsSP2Triangles(2, 1, 7, 0, 2, 7, 8, 0),
    gsSP2Triangles(3, 4, 10, 0, 3, 10, 9, 0),
    gsSP2Triangles(4, 5, 11, 0, 4, 11, 10, 0),
    gsSP2Triangles(5, 6, 12, 0, 5, 12, 11, 0),
    gsSP2Triangles(6, 0, 13, 0, 6, 13, 12, 0),
    gsSPVertex(&D_ZO_6009ED0[144], 2, 0),
    gsSPVertex(&D_ZO_6009ED0[148], 1, 2),
    gsSPVertex(&D_ZO_6009ED0[153], 1, 3),
    gsSPVertex(&D_ZO_6009ED0[165], 1, 4),
    gsSPVertex(&D_ZO_6009ED0[169], 1, 5),
    gsSPVertex(&D_ZO_6009ED0[208], 6, 6),
    gsSPVertex(&D_ZO_6009ED0[284], 1, 12),
    gsSPVertex(&D_ZO_6009ED0[288], 1, 13),
    gsSP2Triangles(6, 13, 12, 0, 6, 12, 5, 0),
    gsSP2Triangles(7, 6, 5, 0, 7, 5, 4, 0),
    gsSP2Triangles(8, 9, 0, 0, 8, 0, 1, 0),
    gsSP2Triangles(9, 10, 2, 0, 9, 2, 0, 0),
    gsSP2Triangles(10, 11, 3, 0, 10, 3, 2, 0),
    gsSPVertex(&D_ZO_6009ED0[145], 1, 0),
    gsSPVertex(&D_ZO_6009ED0[153], 1, 1),
    gsSPVertex(&D_ZO_6009ED0[156], 1, 2),
    gsSPVertex(&D_ZO_6009ED0[159], 1, 3),
    gsSPVertex(&D_ZO_6009ED0[162], 1, 4),
    gsSPVertex(&D_ZO_6009ED0[165], 1, 5),
    gsSPVertex(&D_ZO_6009ED0[171], 1, 6),
    gsSPVertex(&D_ZO_6009ED0[209], 2, 7),
    gsSPVertex(&D_ZO_6009ED0[213], 5, 9),
    gsSP2Triangles(9, 10, 2, 0, 9, 2, 1, 0),
    gsSP2Triangles(10, 11, 3, 0, 10, 3, 2, 0),
    gsSP2Triangles(11, 12, 4, 0, 11, 4, 3, 0),
    gsSP2Triangles(12, 7, 5, 0, 12, 5, 4, 0),
    gsSP2Triangles(13, 8, 0, 0, 13, 0, 6, 0),
    gsSPVertex(&D_ZO_6009ED0[171], 1, 0),
    gsSPVertex(&D_ZO_6009ED0[174], 1, 1),
    gsSPVertex(&D_ZO_6009ED0[176], 1, 2),
    gsSPVertex(&D_ZO_6009ED0[180], 1, 3),
    gsSPVertex(&D_ZO_6009ED0[183], 1, 4),
    gsSPVertex(&D_ZO_6009ED0[186], 1, 5),
    gsSPVertex(&D_ZO_6009ED0[189], 1, 6),
    gsSPVertex(&D_ZO_6009ED0[217], 7, 7),
    gsSP2Triangles(8, 9, 2, 0, 8, 2, 1, 0),
    gsSP2Triangles(9, 10, 3, 0, 9, 3, 2, 0),
    gsSP2Triangles(10, 11, 4, 0, 10, 4, 3, 0),
    gsSP2Triangles(11, 12, 5, 0, 11, 5, 4, 0),
    gsSP2Triangles(12, 13, 6, 0, 12, 6, 5, 0),
    gsSP2Triangles(13, 7, 0, 0, 13, 0, 6, 0),
    gsSPVertex(&D_ZO_6009ED0[66], 2, 0),
    gsSPVertex(&D_ZO_6009ED0[70], 1, 2),
    gsSPVertex(&D_ZO_6009ED0[72], 1, 3),
    gsSPVertex(&D_ZO_6009ED0[74], 1, 4),
    gsSPVertex(&D_ZO_6009ED0[224], 10, 5),
    gsSP2Triangles(5, 10, 2, 0, 5, 2, 0, 0),
    ...
    gsSP2Triangles(11, 13, 14, 0, 11, 14, 12, 0),
    gsSP2Triangles(12, 14, 4, 0, 12, 4, 3, 0),
    gsSPVertex(&D_ZO_6009ED0[74], 1, 0),
    gsSPVertex(&D_ZO_6009ED0[76], 1, 1),
    gsSPVertex(&D_ZO_6009ED0[78], 1, 2),
    gsSPVertex(&D_ZO_6009ED0[80], 1, 3),
    gsSPVertex(&D_ZO_6009ED0[232], 8, 4),
    gsSPVertex(&D_ZO_6009ED0[262], 1, 12),
    gsSPVertex(&D_ZO_6009ED0[286], 2, 13),
    ...
    gsSP2Triangles(11, 14, 12, 0, 11, 12, 3, 0),
    gsSPVertex(&D_ZO_6009ED0[67], 1, 0),
    gsSPVertex(&D_ZO_6009ED0[82], 1, 1),
    gsSPVertex(&D_ZO_6009ED0[84], 2, 2),
    gsSPVertex(&D_ZO_6009ED0[88], 1, 4),
    gsSPVertex(&D_ZO_6009ED0[226], 2, 5),
    gsSPVertex(&D_ZO_6009ED0[240], 8, 7),
    gsSP2Triangles(7, 5, 6, 0, 7, 6, 8, 0),
    gsSP2Triangles(8, 6, 0, 0, 8, 0, 1, 0),
    gsSP2Triangles(9, 13, 14, 0, 9, 14, 11, 0),
    gsSP2Triangles(10, 9, 11, 0, 10, 11, 12, 0),
    gsSP2Triangles(11, 14, 4, 0, 11, 4, 3, 0),
    gsSP2Triangles(12, 11, 3, 0, 12, 3, 2, 0),
    gsSPVertex(&D_ZO_6009ED0[88], 1, 0),
    gsSPVertex(&D_ZO_6009ED0[90], 1, 1),
    gsSPVertex(&D_ZO_6009ED0[92], 1, 2),
    gsSPVertex(&D_ZO_6009ED0[94], 1, 3),
    gsSPVertex(&D_ZO_6009ED0[96], 1, 4),
    gsSPVertex(&D_ZO_6009ED0[246], 10, 5),
    gsSP2Triangles(5, 7, 8, 0, 5, 8, 6, 0),
    gsSP2Triangles(6, 8, 1, 0, 6, 1, 0, 0),
    gsSP2Triangles(7, 9, 10, 0, 7, 10, 8, 0),
    gsSP2Triangles(8, 10, 2, 0, 8, 2, 1, 0),
    ...
    gsSP2Triangles(11, 13, 14, 0, 11, 14, 12, 0),
    gsSP2Triangles(12, 14, 4, 0, 12, 4, 3, 0),
    gsSPVertex(&D_ZO_6009ED0[82], 1, 0),
    gsSPVertex(&D_ZO_6009ED0[96], 1, 1),
    gsSPVertex(&D_ZO_6009ED0[240], 2, 2),
    gsSPVertex(&D_ZO_6009ED0[254], 2, 4),
    gsSP2Triangles(4, 2, 3, 0, 4, 3, 5, 0),
    gsSP2Triangles(5, 3, 0, 0, 5, 0, 1, 0),
    gsSPEndDisplayList(),
};

Gfx twotri_aZoWater2DL[] = {
    gsDPTileSync(),
    gsDPSetTile(G_IM_FMT_RGBA, G_IM_SIZ_16b, 8, 0x0000, G_TX_RENDERTILE, 0, G_TX_NOMIRROR | G_TX_WRAP, 5, G_TX_NOLOD, G_TX_NOMIRROR | G_TX_WRAP, 5, G_TX_NOLOD),
    gsDPSetTileSize(G_TX_RENDERTILE, 0, 0, 0x007C, 0x007C),
    gsDPSetTextureImage(G_IM_FMT_RGBA, G_IM_SIZ_16b, 1, aZoWaterTex),
    ...
    gsSP2Triangles(6, 8, 12, 0, 6, 12, 13, 0),
    gsSP2Triangles(8, 11, 14, 0, 8, 14, 12, 0),
    gsSPVertex(&D_ZO_600C780[6], 2, 0),
    gsSPVertex(&D_ZO_600C780[9], 3, 2),
    gsSPVertex(&D_ZO_600C780[13], 9, 5),
    gsSPVertex(&D_ZO_600C780[56], 1, 14),
    gsSP2Triangles(1, 0, 5, 0, 1, 5, 7, 0),
    gsSP2Triangles(2, 8, 9, 0, 2, 9, 3, 0),
    gsSP2Triangles(3, 9, 10, 0, 3, 10, 4, 0),
    gsSP2Triangles(4, 10, 14, 0, 4, 14, 6, 0),
    gsSP2Triangles(8, 11, 12, 0, 8, 12, 9, 0),
    gsSP2Triangles(9, 12, 13, 0, 9, 13, 10, 0),
    gsSPVertex(&D_ZO_600C780[18], 10, 0),
    gsSPVertex(&D_ZO_600C780[56], 4, 10),
    gsSP2Triangles(0, 3, 11, 0, 0, 11, 10, 0),
    gsSP2Triangles(1, 4, 5, 0, 1, 5, 2, 0),
    gsSP2Triangles(2, 5, 6, 0, 2, 6, 3, 0),
    gsSP2Triangles(3, 6, 12, 0, 3, 12, 11, 0),
    ...
    gsSP2Triangles(5, 8, 9, 0, 5, 9, 6, 0),
    gsSP2Triangles(6, 9, 13, 0, 6, 13, 12, 0),
    gsSPVertex(D_ZO_600C780, 1, 0),
    gsSPVertex(&D_ZO_600C780[3], 1, 1),
    gsSPVertex(&D_ZO_600C780[7], 1, 2),
    gsSPVertex(&D_ZO_600C780[25], 6, 3),
    gsSPVertex(&D_ZO_600C780[59], 1, 9),
    gsSPVertex(&D_ZO_600C780[256], 4, 10),
    gsSP2Triangles(3, 10, 11, 0, 3, 11, 4, 0),
    gsSP2Triangles(4, 11, 12, 0, 4, 12, 5, 0),
    gsSP2Triangles(5, 12, 13, 0, 5, 13, 9, 0),
    gsSP2Triangles(6, 0, 1, 0, 6, 1, 7, 0),
    gsSP2Triangles(7, 1, 2, 0, 7, 2, 8, 0),
    gsSPVertex(&D_ZO_600C780[7], 1, 0),
    gsSPVertex(&D_ZO_600C780[15], 1, 1),
    gsSPVertex(&D_ZO_600C780[30], 13, 2),
    gsSPVertex(&D_ZO_600C780[60], 1, 15),
    gsSP2Triangles(2, 0, 1, 0, 2, 1, 15, 0),
    gsSP2Triangles(3, 4, 6, 0, 3, 6, 5, 0),
    gsSP2Triangles(4, 7, 8, 0, 4, 8, 6, 0),
    gsSP2Triangles(5, 6, 9, 0, 5, 9, 11, 0),
    ...
    gsSP2Triangles(7, 12, 13, 0, 7, 13, 8, 0),
    gsSP2Triangles(8, 13, 14, 0, 8, 14, 10, 0),
    gsSPVertex(&D_ZO_600C780[37], 9, 0),
    gsSPVertex(&D_ZO_600C780[52], 2, 9),
    gsSPVertex(&D_ZO_600C780[61], 3, 11),
    gsSP2Triangles(0, 1, 11, 0, 0, 11, 10, 0),
    gsSP2Triangles(1, 5, 12, 0, 1, 12, 11, 0),
    gsSP2Triangles(2, 0, 10, 0, 2, 10, 9, 0),
    gsSP2Triangles(3, 6, 7, 0, 3, 7, 4, 0),
    gsSP2Triangles(4, 7, 8, 0, 4, 8, 5, 0),
    gsSP2Triangles(5, 8, 13, 0, 5, 13, 12, 0),
    gsSPVertex(&D_ZO_600C780[28], 3, 0),
    gsSPVertex(&D_ZO_600C780[43], 9, 3),
    gsSPVertex(&D_ZO_600C780[63], 3, 12),
    gsSP2Triangles(3, 6, 7, 0, 3, 7, 4, 0),
    gsSP2Triangles(4, 7, 8, 0, 4, 8, 5, 0),
    gsSP2Triangles(5, 8, 13, 0, 5, 13, 12, 0),
    gsSP2Triangles(6, 9, 10, 0, 6, 10, 7, 0),
    ...
    gsSP2Triangles(9, 0, 1, 0, 9, 1, 10, 0),
    gsSP2Triangles(10, 1, 2, 0, 10, 2, 11, 0),
    gsSPVertex(&D_ZO_600C780[12], 3, 0),
    gsSPVertex(&D_ZO_600C780[30], 1, 3),
    gsSPVertex(&D_ZO_600C780[51], 5, 4),
    gsSPVertex(&D_ZO_600C780[60], 2, 9),
    gsSPVertex(&D_ZO_600C780[65], 1, 11),
    gsSPVertex(&D_ZO_600C780[98], 3, 12),
    gsSPVertex(&D_ZO_600C780[127], 1, 15),
    gsSP2Triangles(4, 3, 9, 0, 4, 9, 11, 0),
    gsSP2Triangles(5, 6, 13, 0, 5, 13, 12, 0),
    gsSP2Triangles(6, 10, 15, 0, 6, 15, 13, 0),
    gsSP2Triangles(0, 2, 7, 0, 0, 7, 8, 0),
    gsSP2Triangles(1, 0, 8, 0, 1, 8, 14, 0),
    gsSPVertex(&D_ZO_600C780[13], 3, 0),
    gsSPVertex(&D_ZO_600C780[54], 1, 3),
    gsSPVertex(&D_ZO_600C780[56], 4, 4),
    gsSPVertex(&D_ZO_600C780[100], 2, 8),
    gsSPVertex(&D_ZO_600C780[110], 1, 10),
    gsSPVertex(&D_ZO_600C780[113], 1, 11),
    gsSPVertex(&D_ZO_600C780[116], 1, 12),
    gsSPVertex(&D_ZO_600C780[119], 1, 13),
    gsSP2Triangles(2, 0, 8, 0, 2, 8, 9, 0),
    gsSP2Triangles(1, 4, 10, 0, 1, 10, 3, 0),
    gsSP2Triangles(4, 5, 11, 0, 4, 11, 10, 0),
    gsSP2Triangles(5, 6, 12, 0, 5, 12, 11, 0),
    gsSP2Triangles(6, 7, 13, 0, 6, 13, 12, 0),
    gsSPVertex(&D_ZO_600C780[15], 1, 0),
    gsSPVertex(&D_ZO_600C780[59], 5, 1),
    gsSPVertex(&D_ZO_600C780[101], 1, 6),
    gsSPVertex(&D_ZO_600C780[119], 1, 7),
    gsSPVertex(&D_ZO_600C780[122], 1, 8),
    gsSPVertex(&D_ZO_600C780[127], 1, 9),
    gsSPVertex(&D_ZO_600C780[132], 1, 10),
    gsSPVertex(&D_ZO_600C780[135], 1, 11),
    gsSPVertex(&D_ZO_600C780[259], 2, 12),
    gsSP2Triangles(1, 12, 13, 0, 1, 13, 7, 0),
    gsSP2Triangles(2, 0, 6, 0, 2, 6, 8, 0),
    gsSP2Triangles(3, 4, 10, 0, 3, 10, 9, 0),
    gsSP2Triangles(4, 5, 11, 0, 4, 11, 10, 0),
    gsSPVertex(D_ZO_600C780, 2, 0),
    gsSPVertex(&D_ZO_600C780[60], 1, 2),
    gsSPVertex(&D_ZO_600C780[63], 9, 3),
    gsSPVertex(&D_ZO_600C780[122], 1, 12),
    gsSPVertex(&D_ZO_600C780[135], 1, 13),
    gsSPVertex(&D_ZO_600C780[138], 1, 14),
    gsSPVertex(&D_ZO_600C780[141], 1, 15),
    gsSP2Triangles(3, 4, 14, 0, 3, 14, 13, 0),
    gsSP2Triangles(4, 5, 15, 0, 4, 15, 14, 0),
    gsSP2Triangles(5, 2, 12, 0, 5, 12, 15, 0),
    gsSP2Triangles(6, 10, 11, 0, 6, 11, 9, 0),
    gsSP2Triangles(7, 6, 9, 0, 7, 9, 8, 0),
    gsSP2Triangles(8, 9, 1, 0, 8, 1, 0, 0),
    gsSPVertex(&D_ZO_600C780[1], 1, 0),
    gsSPVertex(&D_ZO_600C780[4], 1, 1),
    gsSPVertex(&D_ZO_600C780[9], 1, 2),
    gsSPVertex(&D_ZO_600C780[16], 1, 3),
    gsSPVertex(&D_ZO_600C780[19], 1, 4),
    gsSPVertex(&D_ZO_600C780[69], 9, 5),
    gsSP2Triangles(6, 8, 9, 0, 6, 9, 7, 0),
    gsSP2Triangles(5, 7, 1, 0, 5, 1, 0, 0),
    gsSP2Triangles(7, 9, 2, 0, 7, 2, 1, 0),
    gsSP2Triangles(8, 10, 11, 0, 8, 11, 9, 0),
    ...
    gsSP2Triangles(10, 12, 13, 0, 10, 13, 11, 0),
    gsSP2Triangles(11, 13, 4, 0, 11, 4, 3, 0),
    gsSPVertex(&D_ZO_600C780[19], 1, 0),
    gsSPVertex(&D_ZO_600C780[22], 1, 1),
    gsSPVertex(&D_ZO_600C780[25], 1, 2),
    gsSPVertex(&D_ZO_600C780[67], 2, 3),
    gsSPVertex(&D_ZO_600C780[76], 8, 5),
    gsSPVertex(&D_ZO_600C780[256], 1, 13),
    gsSPVertex(&D_ZO_600C780[262], 2, 14),
    gsSP2Triangles(5, 7, 8, 0, 5, 8, 6, 0),
    gsSP2Triangles(6, 8, 1, 0, 6, 1, 0, 0),
    gsSP2Triangles(7, 9, 10, 0, 7, 10, 8, 0),
    gsSP2Triangles(8, 10, 2, 0, 8, 2, 1, 0),
    ...
    gsSP2Triangles(11, 3, 4, 0, 11, 4, 12, 0),
    gsSPVertex(D_ZO_600C780, 1, 0),
    gsSPVertex(&D_ZO_600C780[28], 1, 1),
    gsSPVertex(&D_ZO_600C780[31], 2, 2),
    gsSPVertex(&D_ZO_600C780[35], 1, 4),
    gsSPVertex(&D_ZO_600C780[40], 1, 5),
    gsSPVertex(&D_ZO_600C780[68], 1, 6),
    gsSPVertex(&D_ZO_600C780[83], 9, 7),
    gsSP2Triangles(7, 6, 0, 0, 7, 0, 1, 0),
    gsSP2Triangles(8, 9, 10, 0, 8, 10, 11, 0),
    gsSP2Triangles(9, 12, 13, 0, 9, 13, 10, 0),
    gsSP2Triangles(10, 13, 4, 0, 10, 4, 3, 0),
    ...
    gsSP2Triangles(12, 14, 15, 0, 12, 15, 13, 0),
    gsSP2Triangles(13, 15, 5, 0, 13, 5, 4, 0),
    gsSPVertex(&D_ZO_600C780[28], 1, 0),
    gsSPVertex(&D_ZO_600C780[40], 1, 1),
    gsSPVertex(&D_ZO_600C780[43], 1, 2),
    gsSPVertex(&D_ZO_600C780[46], 1, 3),
    gsSPVertex(&D_ZO_600C780[49], 1, 4),
    gsSPVertex(&D_ZO_600C780[82], 2, 5),
    gsSPVertex(&D_ZO_600C780[90], 8, 7),
    gsSP2Triangles(7, 9, 10, 0, 7, 10, 8, 0),
    gsSP2Triangles(8, 10, 2, 0, 8, 2, 1, 0),
    gsSP2Triangles(9, 11, 12, 0, 9, 12, 10, 0),
    gsSP2Triangles(10, 12, 3, 0, 10, 3, 2, 0),
    ...
    gsSP2Triangles(13, 5, 6, 0, 13, 6, 14, 0),
    gsSP2Triangles(14, 6, 0, 0, 14, 0, 4, 0),
    gsSPVertex(&D_ZO_600C780[55], 1, 0),
    gsSPVertex(&D_ZO_600C780[98], 10, 1),
    gsSPVertex(&D_ZO_600C780[125], 4, 11),
    gsSP2Triangles(1, 2, 11, 0, 1, 11, 12, 0),
    gsSP2Triangles(2, 13, 14, 0, 2, 14, 11, 0),
    gsSP2Triangles(3, 0, 7, 0, 3, 7, 6, 0),
    gsSP2Triangles(4, 3, 6, 0, 4, 6, 5, 0),
    gsSP2Triangles(5, 6, 8, 0, 5, 8, 10, 0),
    gsSP2Triangles(6, 7, 9, 0, 6, 9, 8, 0),
    gsSPVertex(&D_ZO_600C780[54], 2, 0),
    gsSPVertex(&D_ZO_600C780[104], 9, 2),
    gsSPVertex(&D_ZO_600C780[264], 4, 11),
    gsSP2Triangles(1, 0, 6, 0, 1, 6, 2, 0),
    gsSP2Triangles(2, 6, 7, 0, 2, 7, 4, 0),
    gsSP2Triangles(3, 4, 11, 0, 3, 11, 12, 0),
    gsSP2Triangles(4, 7, 13, 0, 4, 13, 11, 0),
    ...
    gsSP2Triangles(0, 8, 9, 0, 0, 9, 6, 0),
    gsSP2Triangles(6, 9, 10, 0, 6, 10, 7, 0),
    gsSPVertex(&D_ZO_600C780[109], 10, 0),
    gsSPVertex(&D_ZO_600C780[266], 1, 10),
    gsSPVertex(&D_ZO_600C780[268], 3, 11),
    gsSP2Triangles(0, 3, 11, 0, 0, 11, 10, 0),
    gsSP2Triangles(1, 4, 5, 0, 1, 5, 2, 0),
    gsSP2Triangles(2, 5, 6, 0, 2, 6, 3, 0),
    gsSP2Triangles(3, 6, 12, 0, 3, 12, 11, 0),
    ...
    gsSP2Triangles(5, 8, 9, 0, 5, 9, 6, 0),
    gsSP2Triangles(6, 9, 13, 0, 6, 13, 12, 0),
    gsSPVertex(&D_ZO_600C780[101], 2, 0),
    gsSPVertex(&D_ZO_600C780[116], 8, 2),
    gsSPVertex(&D_ZO_600C780[260], 2, 10),
    gsSPVertex(&D_ZO_600C780[270], 4, 12),
    gsSP2Triangles(2, 5, 6, 0, 2, 6, 3, 0),
    gsSP2Triangles(3, 6, 7, 0, 3, 7, 4, 0),
    gsSP2Triangles(4, 7, 13, 0, 4, 13, 12, 0),
    gsSP2Triangles(5, 10, 11, 0, 5, 11, 6, 0),
    ...
    gsSP2Triangles(7, 14, 15, 0, 7, 15, 13, 0),
    gsSP2Triangles(8, 0, 1, 0, 8, 1, 9, 0),
    gsSPVertex(&D_ZO_600C780[102], 1, 0),
    gsSPVertex(&D_ZO_600C780[107], 1, 1),
    gsSPVertex(&D_ZO_600C780[123], 12, 2),
    gsSPVertex(&D_ZO_600C780[267], 1, 14),
    gsSPVertex(&D_ZO_600C780[274], 1, 15),
    gsSP2Triangles(2, 0, 1, 0, 2, 1, 3, 0),
    gsSP2Triangles(3, 1, 14, 0, 3, 14, 15, 0),
    gsSP2Triangles(4, 7, 8, 0, 4, 8, 9, 0),
    gsSP2Triangles(5, 4, 9, 0, 5, 9, 10, 0),
    gsSP2Triangles(6, 11, 12, 0, 6, 12, 7, 0),
    gsSP2Triangles(7, 12, 13, 0, 7, 13, 8, 0),
    gsSPVertex(&D_ZO_600C780[129], 9, 0),
    gsSPVertex(&D_ZO_600C780[275], 5, 9),
    gsSP2Triangles(0, 5, 9, 0, 0, 9, 10, 0),
    gsSP2Triangles(1, 0, 10, 0, 1, 10, 11, 0),
    gsSP2Triangles(2, 1, 11, 0, 2, 11, 12, 0),
    gsSP2Triangles(3, 6, 7, 0, 3, 7, 4, 0),
    gsSP2Triangles(4, 7, 8, 0, 4, 8, 5, 0),
    gsSP2Triangles(5, 8, 13, 0, 5, 13, 9, 0),
    gsSPVertex(&D_ZO_600C780[122], 3, 0),
    gsSPVertex(&D_ZO_600C780[135], 9, 3),
    gsSPVertex(&D_ZO_600C780[279], 3, 12),
    gsSP2Triangles(3, 6, 7, 0, 3, 7, 4, 0),
    gsSP2Triangles(4, 7, 8, 0, 4, 8, 5, 0),
    gsSP2Triangles(5, 8, 13, 0, 5, 13, 12, 0),
    gsSP2Triangles(6, 9, 10, 0, 6, 10, 7, 0),
    ...
    gsSP2Triangles(9, 0, 1, 0, 9, 1, 10, 0),
    gsSP2Triangles(10, 1, 2, 0, 10, 2, 11, 0),
    gsSPVertex(&D_ZO_600C780[124], 1, 0),
    gsSPVertex(&D_ZO_600C780[143], 13, 1),
    gsSPVertex(&D_ZO_600C780[274], 1, 14),
    gsSPVertex(&D_ZO_600C780[281], 1, 15),
    gsSP2Triangles(1, 0, 14, 0, 1, 14, 15, 0),
    gsSP2Triangles(2, 6, 7, 0, 2, 7, 5, 0),
    gsSP2Triangles(3, 2, 5, 0, 3, 5, 4, 0),
    gsSP2Triangles(4, 5, 8, 0, 4, 8, 10, 0),
    ...
    gsSP2Triangles(6, 11, 12, 0, 6, 12, 7, 0),
    gsSP2Triangles(7, 12, 13, 0, 7, 13, 9, 0),
    gsSPVertex(&D_ZO_600C780[150], 9, 0),
    gsSPVertex(&D_ZO_600C780[192], 5, 9),
    gsSP2Triangles(0, 1, 9, 0, 0, 9, 10, 0),
    gsSP2Triangles(1, 5, 12, 0, 1, 12, 9, 0),
    gsSP2Triangles(2, 0, 10, 0, 2, 10, 11, 0),
    gsSP2Triangles(3, 6, 7, 0, 3, 7, 4, 0),
    gsSP2Triangles(4, 7, 8, 0, 4, 8, 5, 0),
    gsSP2Triangles(5, 8, 13, 0, 5, 13, 12, 0),
    gsSPVertex(&D_ZO_600C780[156], 12, 0),
    gsSPVertex(&D_ZO_600C780[196], 3, 12),
    gsSP2Triangles(0, 3, 4, 0, 0, 4, 1, 0),
    gsSP2Triangles(1, 4, 5, 0, 1, 5, 2, 0),
    gsSP2Triangles(2, 5, 13, 0, 2, 13, 12, 0),
    gsSP2Triangles(3, 6, 7, 0, 3, 7, 4, 0),
    ...
    gsSP2Triangles(6, 9, 10, 0, 6, 10, 7, 0),
    gsSP2Triangles(7, 10, 11, 0, 7, 11, 8, 0),
    gsSPVertex(&D_ZO_600C780[164], 7, 0),
    gsSPVertex(&D_ZO_600C780[198], 3, 7),
    gsSPVertex(&D_ZO_600C780[282], 4, 10),
    gsSP2Triangles(0, 3, 8, 0, 0, 8, 7, 0),
    gsSP2Triangles(1, 5, 4, 0, 1, 4, 2, 0),
    gsSP2Triangles(2, 4, 6, 0, 2, 6, 3, 0),
    gsSP2Triangles(3, 6, 9, 0, 3, 9, 8, 0),
    ...
    gsSP2Triangles(5, 12, 10, 0, 5, 10, 4, 0),
    gsSP2Triangles(6, 11, 13, 0, 6, 13, 9, 0),
    gsSPVertex(&D_ZO_600C780[145], 2, 0),
    gsSPVertex(&D_ZO_600C780[152], 1, 2),
    gsSPVertex(&D_ZO_600C780[171], 9, 3),
    gsSPVertex(&D_ZO_600C780[194], 1, 12),
    gsSPVertex(&D_ZO_600C780[201], 1, 13),
    gsSP2Triangles(3, 0, 1, 0, 3, 1, 4, 0),
    gsSP2Triangles(4, 1, 2, 0, 4, 2, 5, 0),
    gsSP2Triangles(5, 2, 12, 0, 5, 12, 13, 0),
    gsSP2Triangles(6, 8, 9, 0, 6, 9, 7, 0),
    gsSP2Triangles(7, 9, 10, 0, 7, 10, 11, 0),
    gsSPVertex(&D_ZO_600C780[176], 10, 0),
    gsSPVertex(&D_ZO_600C780[202], 4, 10),
    gsSP2Triangles(0, 4, 5, 0, 0, 5, 1, 0),
    gsSP2Triangles(1, 5, 6, 0, 1, 6, 2, 0),
    gsSP2Triangles(2, 6, 12, 0, 2, 12, 10, 0),
    gsSP2Triangles(3, 2, 10, 0, 3, 10, 11, 0),
    ...
    gsSP2Triangles(5, 8, 9, 0, 5, 9, 6, 0),
    gsSP2Triangles(6, 9, 13, 0, 6, 13, 12, 0),
    gsSPVertex(&D_ZO_600C780[171], 3, 0),
    gsSPVertex(&D_ZO_600C780[183], 9, 3),
    gsSPVertex(&D_ZO_600C780[205], 3, 12),
    gsSP2Triangles(3, 6, 7, 0, 3, 7, 4, 0),
    gsSP2Triangles(4, 7, 8, 0, 4, 8, 5, 0),
    gsSP2Triangles(5, 8, 13, 0, 5, 13, 12, 0),
    gsSP2Triangles(6, 9, 10, 0, 6, 10, 7, 0),
    ...
    gsSP2Triangles(9, 0, 1, 0, 9, 1, 10, 0),
    gsSP2Triangles(10, 1, 2, 0, 10, 2, 11, 0),
    gsSPVertex(&D_ZO_600C780[173], 1, 0),
    gsSPVertex(&D_ZO_600C780[191], 6, 1),
    gsSPVertex(&D_ZO_600C780[201], 1, 7),
    gsSPVertex(&D_ZO_600C780[207], 1, 8),
    gsSPVertex(&D_ZO_600C780[225], 2, 9),
    gsSPVertex(&D_ZO_600C780[228], 1, 11),
    gsSPVertex(&D_ZO_600C780[230], 1, 12),
    gsSPVertex(&D_ZO_600C780[240], 1, 13),
    gsSP2Triangles(1, 0, 7, 0, 1, 7, 8, 0),
    gsSP2Triangles(2, 5, 11, 0, 2, 11, 9, 0),
    gsSP2Triangles(3, 2, 9, 0, 3, 9, 10, 0),
    gsSP2Triangles(4, 3, 10, 0, 4, 10, 13, 0),
    gsSP2Triangles(5, 6, 12, 0, 5, 12, 11, 0),
    gsSPVertex(&D_ZO_600C780[194], 1, 0),
    gsSPVertex(&D_ZO_600C780[196], 6, 1),
    gsSPVertex(&D_ZO_600C780[230], 1, 7),
    gsSPVertex(&D_ZO_600C780[232], 1, 8),
    gsSPVertex(&D_ZO_600C780[234], 1, 9),
    gsSPVertex(&D_ZO_600C780[236], 1, 10),
    gsSPVertex(&D_ZO_600C780[238], 1, 11),
    gsSPVertex(&D_ZO_600C780[240], 1, 12),
    gsSPVertex(&D_ZO_600C780[254], 1, 13),
    gsSPVertex(&D_ZO_600C780[285], 2, 14),
    gsSP2Triangles(1, 2, 8, 0, 1, 8, 7, 0),
    gsSP2Triangles(2, 3, 9, 0, 2, 9, 8, 0),
    gsSP2Triangles(3, 4, 10, 0, 3, 10, 9, 0),
    gsSP2Triangles(4, 5, 11, 0, 4, 11, 10, 0),
    gsSP2Triangles(5, 14, 15, 0, 5, 15, 11, 0),
    gsSP2Triangles(6, 0, 12, 0, 6, 12, 13, 0),
    gsSPVertex(&D_ZO_600C780[201], 7, 0),
    gsSPVertex(&D_ZO_600C780[242], 2, 7),
    gsSPVertex(&D_ZO_600C780[246], 1, 9),
    gsSPVertex(&D_ZO_600C780[248], 1, 10),
    gsSPVertex(&D_ZO_600C780[250], 1, 11),
    gsSPVertex(&D_ZO_600C780[252], 1, 12),
    gsSPVertex(&D_ZO_600C780[254], 1, 13),
    gsSP2Triangles(1, 3, 9, 0, 1, 9, 7, 0),
    gsSP2Triangles(2, 1, 7, 0, 2, 7, 8, 0),
    gsSP2Triangles(3, 4, 10, 0, 3, 10, 9, 0),
    ...
    gsSP2Triangles(5, 6, 12, 0, 5, 12, 11, 0),
    gsSP2Triangles(6, 0, 13, 0, 6, 13, 12, 0),
    gsSPVertex(&D_ZO_600C780[144], 2, 0),
    gsSPVertex(&D_ZO_600C780[148], 1, 2),
    gsSPVertex(&D_ZO_600C780[153], 1, 3),
    gsSPVertex(&D_ZO_600C780[165], 1, 4),
    gsSPVertex(&D_ZO_600C780[169], 1, 5),
    gsSPVertex(&D_ZO_600C780[208], 6, 6),
    gsSPVertex(&D_ZO_600C780[284], 1, 12),
    gsSPVertex(&D_ZO_600C780[288], 1, 13),
    gsSP2Triangles(6, 13, 12, 0, 6, 12, 5, 0),
    gsSP2Triangles(7, 6, 5, 0, 7, 5, 4, 0),
    gsSP2Triangles(8, 9, 0, 0, 8, 0, 1, 0),
    gsSP2Triangles(9, 10, 2, 0, 9, 2, 0, 0),
    gsSP2Triangles(10, 11, 3, 0, 10, 3, 2, 0),
    gsSPVertex(&D_ZO_600C780[145], 1, 0),
    gsSPVertex(&D_ZO_600C780[153], 1, 1),
    gsSPVertex(&D_ZO_600C780[156], 1, 2),
    gsSPVertex(&D_ZO_600C780[159], 1, 3),
    gsSPVertex(&D_ZO_600C780[162], 1, 4),
    gsSPVertex(&D_ZO_600C780[165], 1, 5),
    gsSPVertex(&D_ZO_600C780[171], 1, 6),
    gsSPVertex(&D_ZO_600C780[209], 2, 7),
    gsSPVertex(&D_ZO_600C780[213], 5, 9),
    gsSP2Triangles(9, 10, 2, 0, 9, 2, 1, 0),
    gsSP2Triangles(10, 11, 3, 0, 10, 3, 2, 0),
    gsSP2Triangles(11, 12, 4, 0, 11, 4, 3, 0),
    gsSP2Triangles(12, 7, 5, 0, 12, 5, 4, 0),
    gsSP2Triangles(13, 8, 0, 0, 13, 0, 6, 0),
    gsSPVertex(&D_ZO_600C780[171], 1, 0),
    gsSPVertex(&D_ZO_600C780[174], 1, 1),
    gsSPVertex(&D_ZO_600C780[176], 1, 2),
    gsSPVertex(&D_ZO_600C780[180], 1, 3),
    gsSPVertex(&D_ZO_600C780[183], 1, 4),
    gsSPVertex(&D_ZO_600C780[186], 1, 5),
    gsSPVertex(&D_ZO_600C780[189], 1, 6),
    gsSPVertex(&D_ZO_600C780[217], 7, 7),
    gsSP2Triangles(8, 9, 2, 0, 8, 2, 1, 0),
    gsSP2Triangles(9, 10, 3, 0, 9, 3, 2, 0),
    gsSP2Triangles(10, 11, 4, 0, 10, 4, 3, 0),
    gsSP2Triangles(11, 12, 5, 0, 11, 5, 4, 0),
    gsSP2Triangles(12, 13, 6, 0, 12, 6, 5, 0),
    gsSP2Triangles(13, 7, 0, 0, 13, 0, 6, 0),
    gsSPVertex(&D_ZO_600C780[66], 2, 0),
    gsSPVertex(&D_ZO_600C780[70], 1, 2),
    gsSPVertex(&D_ZO_600C780[72], 1, 3),
    gsSPVertex(&D_ZO_600C780[74], 1, 4),
    gsSPVertex(&D_ZO_600C780[224], 10, 5),
    gsSP2Triangles(5, 10, 2, 0, 5, 2, 0, 0),
    gsSP2Triangles(6, 9, 10, 0, 6, 10, 5, 0),
    gsSP2Triangles(7, 6, 5, 0, 7, 5, 8, 0),
    gsSP2Triangles(8, 5, 0, 0, 8, 0, 1, 0),
    ...
    gsSP2Triangles(11, 13, 14, 0, 11, 14, 12, 0),
    gsSP2Triangles(12, 14, 4, 0, 12, 4, 3, 0),
    gsSPVertex(&D_ZO_600C780[74], 1, 0),
    gsSPVertex(&D_ZO_600C780[76], 1, 1),
    gsSPVertex(&D_ZO_600C780[78], 1, 2),
    gsSPVertex(&D_ZO_600C780[80], 1, 3),
    gsSPVertex(&D_ZO_600C780[232], 8, 4),
    gsSPVertex(&D_ZO_600C780[262], 1, 12),
    gsSPVertex(&D_ZO_600C780[286], 2, 13),
    gsSP2Triangles(4, 6, 7, 0, 4, 7, 5, 0),
    gsSP2Triangles(5, 7, 1, 0, 5, 1, 0, 0),
    gsSP2Triangles(6, 8, 9, 0, 6, 9, 7, 0),
    gsSP2Triangles(7, 9, 2, 0, 7, 2, 1, 0),
    ...
    gsSP2Triangles(10, 13, 14, 0, 10, 14, 11, 0),
    gsSP2Triangles(11, 14, 12, 0, 11, 12, 3, 0),
    gsSPVertex(&D_ZO_600C780[67], 1, 0),
    gsSPVertex(&D_ZO_600C780[82], 1, 1),
    gsSPVertex(&D_ZO_600C780[84], 2, 2),
    gsSPVertex(&D_ZO_600C780[88], 1, 4),
    gsSPVertex(&D_ZO_600C780[226], 2, 5),
    gsSPVertex(&D_ZO_600C780[240], 8, 7),
    gsSP2Triangles(7, 5, 6, 0, 7, 6, 8, 0),
    gsSP2Triangles(8, 6, 0, 0, 8, 0, 1, 0),
    gsSP2Triangles(9, 13, 14, 0, 9, 14, 11, 0),
    gsSP2Triangles(10, 9, 11, 0, 10, 11, 12, 0),
    gsSP2Triangles(11, 14, 4, 0, 11, 4, 3, 0),
    gsSP2Triangles(12, 11, 3, 0, 12, 3, 2, 0),
    gsSPVertex(&D_ZO_600C780[88], 1, 0),
    gsSPVertex(&D_ZO_600C780[90], 1, 1),
    gsSPVertex(&D_ZO_600C780[92], 1, 2),
    gsSPVertex(&D_ZO_600C780[94], 1, 3),
    gsSPVertex(&D_ZO_600C780[96], 1, 4),
    gsSPVertex(&D_ZO_600C780[246], 10, 5),
    gsSP2Triangles(5, 7, 8, 0, 5, 8, 6, 0),
    gsSP2Triangles(6, 8, 1, 0, 6, 1, 0, 0),
    gsSP2Triangles(7, 9, 10, 0, 7, 10, 8, 0),
    gsSP2Triangles(8, 10, 2, 0, 8, 2, 1, 0),
    ...
    gsSP2Triangles(11, 13, 14, 0, 11, 14, 12, 0),
    gsSP2Triangles(12, 14, 4, 0, 12, 4, 3, 0),
    gsSPVertex(&D_ZO_600C780[82], 1, 0),
    gsSPVertex(&D_ZO_600C780[96], 1, 1),
    gsSPVertex(&D_ZO_600C780[240], 2, 2),
    gsSPVertex(&D_ZO_600C780[254], 2, 4),
    gsSP2Triangles(4, 2, 3, 0, 4, 3, 5, 0),
    gsSP2Triangles(5, 3, 0, 0, 5, 0, 1, 0),
    gsSPEndDisplayList(),
};
