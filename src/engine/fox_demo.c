...
#if 0
src/engine/fox_demo.c: In function ‘Cutscene_EnterWarpZone’:
src/engine/fox_demo.c:531:75: warning: operation on ‘gPathProgress’ may be undefined [-Wsequence-point]
  531 |                             player->vel.z = player->zPath = gPathProgress = player->zPath = gSavedPathProgress =
      |                                                             ~~~~~~~~~~~~~~^~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~
  532 |                                 gPathProgress = 0.0f;
      |                                 ~~~~~~~~~~~~~~~~~~~~                       
src/engine/fox_demo.c:531:59: warning: operation on ‘player->zPath’ may be undefined [-Wsequence-point]
  531 |                             player->vel.z = player->zPath = gPathProgress = player->zPath = gSavedPathProgress =
      |                                             ~~~~~~~~~~~~~~^~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~
  532 |                                 gPathProgress = 0.0f;
      |                                 ~~~~~~~~~~~~~~~~~~~~    
